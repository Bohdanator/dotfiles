...
alias cz="chezmoi"
alias reload="theme 0 && cz apply && swaymsg reload"
alias reload_hard="theme 0 && cz apply && sudo rsync -rv ~/.root-src/ / && swaymsg reload"
alias grubupdate="sudo grub-install --target=x86_64-efi --efi-directory=/efi --bootloader-id=GRUB && sudo grub-mkconfig -o /boot/grub/grub.cfg"
alias c="code"
